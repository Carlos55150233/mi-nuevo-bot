...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            ...
            start_msg+= ' ➢ Version 1.50.0 Basado en la version v7.0 Fixed\n\n'
            bot.editMessageText(message,start_msg)
             ...
             if loged:
                ...
                i = 1
                for item in List1:
                    info += '<b>/del_'+str(i)+'</b><b>/txt_'+str(i)+'</b>\n'
                    #info += '<b>'+item['name']+':</b>\n'
            ...
            if loged:
                ...
                bot.editMessageText(message,'✕Error y Causas🧐\n1-Revise su Cuenta\n2-Servidor Desabilitado: '+client.path)
        elif '/del_all' in msgText and user_info['cloudtype']=='moodle':
            proxy = ProxyCloud.parse(user_info['proxy'])
            client = MoodleClient(user_info['moodle_user'],
                                   user_info['moodle_password'],
                                   user_info['moodle_host'],
...
def main():
    ...
    bot_token = '5516658502:AAFnePKHyBcVgHlmdW-ITQRnaWP5KfIO7Oo'
